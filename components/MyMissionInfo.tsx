...
export default function AboutInfo() {
    ...
    return (
        <div className="mt-16 mb-8 flex flex-col-reverse lg:flex-row-reverse sm:items-start lg:gap-8 md:gap-6 gap-4">
            <div className="overflow-hidden rounded-tr-3xl rounded-br-3xl">
